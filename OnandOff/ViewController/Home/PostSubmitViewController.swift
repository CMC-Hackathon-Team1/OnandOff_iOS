...
class PostSubmitViewController: UIViewController {
...
//MARK: - Properties
    ...
    let backButton = UIButton().then{
        $0.setImage(UIImage(named: "arrowx1")?.withRenderingMode(.alwaysOriginal), for: .normal)
    }
...
extension PostSubmitViewController: UITextViewDelegate {
